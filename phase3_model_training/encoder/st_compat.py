...
def apply() -> None:
    ...
    # 3) HF Trainer/safetensors odbija non-contiguous tenzore (Electra/BERTić).
    # Forsiraj stari torch.save format — setdefault NIJE dovoljan jer Trainer
    # često eksplicitno šalje safe_serialization=True.
